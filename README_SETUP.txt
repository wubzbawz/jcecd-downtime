JCECD SHARED EMERGENCY CALL ENTRY v2
...
V2 CHANGES
- CP initial narrative is entered one line at a time.
- Press Enter to timestamp and append each line to the visible draft narrative.
- Draft lines can be removed before sending.
- REOPEN moves a closed call back to ACTIVE and records the action.
- CLOSED includes EXPORT ALL CLOSED CALLS CSV for post-outage reconciliation.
